...
struct PSBTData {
    ...
    bytes32 actualTxnHash; // actualTxnHash to record the transaction hash of the actual burn transaction
    ...
    bytes32 taprootAddress; // Taproot publicKey for the mint or burn transaction
    bytes32 networkKey; // AVS Bitcoin publicKey
